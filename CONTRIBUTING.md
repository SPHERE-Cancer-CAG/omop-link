# Contributing to omop-cdm

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
omop-cdm. These guidelines are not strict rules.
...
The omop-cdm team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the omop-cdm technical leads
...
[issues]: https://github.com/SPHERE-Cancer-CAG/omop-cdm/issues/
[pulls]: https://github.com/SPHERE-Cancer-CAG/omop-cdm/pulls/
